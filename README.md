...
Four projects share this repository. None of them builds, imports or deploys
another, and no two share a line of code. They are not all unrelated, though,
and the relations are in content rather than code: the website and the Android
app are for the same company and share a unit schedule and its Arabic wording,
and the two tender monitors solve the same problem twice.
