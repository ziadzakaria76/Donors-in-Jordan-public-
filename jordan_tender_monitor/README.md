...
| `test_pipeline.py` (77) | What happens *afterwards* — filters, scoring, eligibility penalty, deduplication, report rendering, Excel/CSV/JSON writers, email fallback, the seen-tender tracker |
