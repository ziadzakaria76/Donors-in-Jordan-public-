...
switch: see `DECISIONS.md` → D-23 for exactly what came out. The external track
was briefly re-sized to cover the loss and then put back, when the owner removed
the cost-per-lead assumption that re-sizing rested on.
